...
//            jarr = j.getJSONArray(resp);
        ...
        lView = (ListView) findViewById(R.id.androidListU);

        lAdapter = new ListAdapter(Upcoming.this, title, prediction, images);
        ...
        lView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(Upcoming.this, title[i]+" "+prediction[i], Toast.LENGTH_SHORT).show();
